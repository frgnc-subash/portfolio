...
export default function Navbar() {
  ...
  return (
    <nav className="relative flex items-center justify-between w-full max-w-2xl mx-auto px-4 py-4 sm:py-6 bg-transparent z-50">
      ...
      <div
        className={`fixed inset-0 z-40 bg-black/30 backdrop-blur-[2px] transition-opacity duration-300 sm:hidden ${isOpen ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"}`}
