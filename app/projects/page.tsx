        ...
        {PROJECTS.map((project) => (
          ...
          >
            <div className="relative aspect-[16/9] w-full overflow-hidden border-b border-gray-200 bg-[#111214] dark:border-[#323437]">
              ...
              />
              {!project.image && (
                <div className="absolute inset-0 grid place-items-center bg-[#111214]/80 p-6 text-center">
            ...
            <div className="p-5">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((technology) => (
                  <span
                    key={technology}
                    className="rounded border border-gray-200 bg-gray-100 px-2 py-1 text-[10px] font-medium text-gray-600 dark:border-[#323437] dark:bg-[#1e1e1e] dark:text-gray-300"
                  >
                    {technology}
                  </span>
                ))}
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                {project.github &&
                  (project.sourceDisabled ? (
                    <span
                      aria-disabled="true"
                      className="inline-flex cursor-not-allowed items-center gap-2 rounded-md border border-gray-200 px-3.5 py-2 text-sm font-medium text-gray-400 opacity-60 dark:border-[#3d3f43] dark:text-gray-500"
                    >
                      <Github size={16} />
                      Source
                    </span>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-md border border-gray-200 px-3.5 py-2 text-sm font-medium text-gray-700 transition-colors hover:border-gray-300 hover:bg-gray-50 dark:border-[#3d3f43] dark:text-[#e4e4e4] dark:hover:bg-[#1e1e1e]"
                    >
                      <Github size={16} />
                      Source
                    </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-md bg-black px-3.5 py-2 text-sm font-medium text-white transition-opacity hover:opacity-80 dark:bg-[#e4e4e4] dark:text-black"
                >
