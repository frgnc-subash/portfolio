      ...
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-black border-2 border-cyan-400/60 rounded-lg p-8 shadow-[0_0_20px_rgba(0,255,255,0.5)]">
          <div className="flex items-center justify-center space-x-2">
            <span className="text-cyan-300 font-mono animate-pulse">LOADING</span>
            <span className="text-cyan-300 animate-pulse">.</span>
            <span className="text-cyan-300 animate-pulse" style={{animationDelay: '0.2s'}}>.</span>
            <span className="text-cyan-300 animate-pulse" style={{animationDelay: '0.4s'}}>.</span>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-black border-2 border-red-500/60 rounded-lg p-8 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
          <p className="text-red-400 font-mono text-center">❌ WEATHER OFFLINE</p>
        </div>
      </div>
    );
  }
      ...
      content: (
        <div className="text-center py-4">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-green-400 text-xs font-mono uppercase">Kathmandu Online</span>
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="flex items-center justify-around py-4">
          <div className="text-center">
            ...
            <p className="text-cyan-300 text-sm font-mono capitalize">{weather.weather[0].description}</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-purple-400 text-sm font-mono mt-2">Feels {feelsLike}°</p>
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="grid grid-cols-3 gap-6 py-4">
          <div className="text-center">
            ...
            <p className="text-xl font-mono font-bold text-cyan-300">{humidity}%</p>
            <p className="text-xs font-mono text-gray-400 uppercase">Humidity</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-1">༄｡°</div>
            <p className="text-xl font-mono font-bold text-cyan-300">{windSpeed}</p>
            <p className="text-xs font-mono text-gray-400 uppercase">Wind m/s</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-1">😶‍🌫️</div>
            <p className="text-xl font-mono font-bold text-cyan-300">{visibility}</p>
            <p className="text-xs font-mono text-gray-400 uppercase">Visible km</p>
          </div>
        </div>
      )
    }
        ...
        <div className="bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-cyan-500/20 px-4 py-2 border-b border-cyan-400/40">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-cyan-300 text-xs uppercase tracking-wider">Weather Here</span>
            </div>
